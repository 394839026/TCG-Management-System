...
require('./models/InventoryViewRequest');
...
app.use('/api/team-decks', require('./routes/teamDeck'));
...
app.use('/api/inventory-view-requests', require('./routes/inventoryViewRequests'));
app.use('/api/music', require('./routes/music'));
app.use('/api/backpack', require('./routes/backpack').router);
